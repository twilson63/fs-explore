-- JavaScript Syntax Highlighter Module
local highlighter = {}
...
local builtins = {
    ...
    ["clearTimeout"] = true, ["clearInterval"] = true, ["undefined"] = true,
    ["null"] = true, ["true"] = true, ["false"] = true, ["Infinity"] = true,
    ["NaN"] = true
}
...
function highlighter.highlight(code)
    ...
    while i <= len do
        ...
        elseif char == '/' and i > 1 then
            -- Simple regex detection (not perfect but works for most cases)
